...
const RefundPolicy = () => {
  ...
  return (
    <div className="bg-white min-h-screen pt-32 pb-24">
      <Helmet>
        <title>Return Policy - Appliance Kick</title>
        <meta name="description" content="Official Return Policy for Appliance Kick. Details on returns, process, and refunds." />
        <link rel="canonical" href="https://www.appliancekick.com/refund-policy" />
      </Helmet>
      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="prose prose-lg max-w-none text-gray-700 leading-relaxed space-y-8">
          ...
          <section>
            ...
            <p>
              To return an item, please email customer service at <a href="mailto:info@appliancekick.shop" className="text-primary font-bold">info@appliancekick.shop</a> to obtain
          ...
          <section>
            ...
            <div className="bg-primary text-white p-8 rounded-2xl shadow-xl mt-4">
              <a href="mailto:info@appliancekick.shop" className="text-secondary font-bold text-lg hover:underline">info@appliancekick.shop</a>
            </div>
          </section>
        </div>
      </div>
