...
const PrivacyPolicy = () => {
  ...
  return (
    <div className="bg-white min-h-screen pt-32 pb-24">
      <Helmet>
        <title>Privacy Policy - Appliance Kick</title>
        <meta name="description" content="Detailed Privacy Policy for Appliance Kick. Understand how we collect, use, and protect your data." />
        <link rel="canonical" href="https://www.appliancekick.com/privacy-policy" />
      </Helmet>
      ...
      <div className="container mx-auto px-4 max-w-5xl">
        ...
        <div className="prose prose-lg max-w-none text-gray-700 leading-relaxed space-y-8">
          <section>
            <p>
              This Privacy Notice for ApplianceKick ("<strong>we</strong>," "<strong>us</strong>," or "<strong>our</strong>"), describes how and why we
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>Visit our website at <a href="http://appliancekick.com/" className="text-primary hover:text-secondary">http://appliancekick.com/</a> or any website of ours that links to this Privacy Notice</li>
            ...
            <p>
              <strong>Questions or concerns?</strong> Reading this Privacy Notice will help you understand your privacy rights and choices. We are responsible for making decisions about how your personal information is processed. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at <a href="mailto:ApplianceKick@outlook.com" className="text-primary">ApplianceKick@outlook.com</a>.
            </p>
          </section>
          ...
          <section id="safe">
            ...
            <p><em>In Short: We aim to protect your personal information through a system of organizational and robust security measures.</em></p>
            <p>We have implemented appropriate and reasonable robust and organizational security measures designed to protect the security of any personal information we process. However, despite our safeguards and efforts to secure your information, no electronic transmission over the Internet or information storage technology can be guaranteed to be 100% secure, so we cannot promise or guarantee that hackers, cybercriminals, or other unauthorized third parties will not be able to defeat our security and improperly collect, access, steal, or modify your information. Although we will do our best to protect your personal information, transmission of personal information to and from our Services is at your own risk. You should only access the Services within a secure environment.</p>
          </section>
          ...
          <section id="rights">
            ...
            <p>If you have questions or comments about your privacy rights, you may email us at <a href="mailto:ApplianceKick@outlook.com" className="text-primary">ApplianceKick@outlook.com</a>.</p>
          </section>
          ...
          <section id="us-residents">
            ...
            <p>To exercise these rights, you can contact us by submitting a data subject access request, by emailing us at <a href="mailto:ApplianceKick@outlook.com" className="text-primary">ApplianceKick@outlook.com</a>, or by referring to the contact details at the bottom of this document.</p>
            ...
            <p>Under certain US state data protection laws, if we decline to take action regarding your request, you may appeal our decision by emailing us at <a href="mailto:ApplianceKick@outlook.com" className="text-primary">ApplianceKick@outlook.com</a>. We will inform you in writing of any action taken or not taken in response to the appeal, including a written explanation of the reasons for the decisions. If your appeal is denied, you may submit a complaint to your state attorney general.</p>
          ...
          <section id="contact">
            ...
            <p>If you have questions or comments about this notice, you may email us at <strong>ApplianceKick@outlook.com</strong> or contact us by post at:</p>
