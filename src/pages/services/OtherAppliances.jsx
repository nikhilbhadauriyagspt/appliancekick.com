...
import { FaCheckCircle, FaShieldAlt, FaTools, FaArrowLeft, FaWrench, FaSearch, FaPlug, FaMicrochip } from 'react-icons/fa';
...
const OtherAppliances = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      desc: "Expert repair of internal wiring, logic boards, and electronic control units.",
      icon: <FaMicrochip />
    },
    {
      title: "Component Swap",
      desc: "Replacing faulty motors, switches, and sensors with verified high-quality parts.",
      icon: <FaTools />
    },
    {
      title: "Safety Compliance",
      desc: "Ensuring all repaired appliances meet standard electrical and mechanical safety protocols.",
      icon: <FaShieldAlt />
    }
  ];
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
            ...
            <div className="w-full lg:w-1/2">
              <div className="relative group">
                ...
                <img
                  ...
                  alt="General Appliance Repair Service"
                />
              </div>
            </div>
            ...
            <div className="w-full lg:w-1/2">
              <div className="inline-flex items-center gap-2.5 px-4 py-1.5 mb-6 rounded-full bg-gray-100 border border-gray-200">
                ...
                <span className="text-[#0f172a] text-xs font-bold uppercase tracking-wider">Versatile Support</span>
              </div>

              <h2 className="text-3xl md:text-5xl font-black text-[#0f172a] mb-8">
                Professional Care for <span className="text-[#1E63FF]">All Home Assets</span>
              </h2>

              <p className="text-gray-500 text-lg md:text-xl leading-relaxed mb-10 font-medium">
                Domestic appliances are essential for modern living. Whether it's a small kitchen gadget or a large utility unit, our certified technicians apply the same level of systematic diagnostic rigor to ensure every device is restored to its optimal working condition.
              </p>

              <div className="flex flex-col gap-5 mb-12">
                {[
                  "Detailed troubleshooting of complex malfunctions",
                  "Repairing power supply units and internal wiring",
                  "Fixing mechanical failures and operational noise",
                  "Support for both common and specialized home brands"
                ].map((item, index) => (
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-24 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-20">
            ...
            <h2 className="text-4xl md:text-5xl font-black text-[#0f172a] mb-6 leading-tight ">
              Versatile Repair <span className="text-[#ff6a00]">Specialists</span>
            </h2>
          </div>
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-24">
          <div className="bg-[#0B0F3B] rounded-[40px] p-10 md:p-16 lg:p-20 text-center relative overflow-hidden shadow-2xl">
            ...
            <div className="flex justify-center relative z-10">
              <button
                onClick={() => openBookingModal('Appliance')}
