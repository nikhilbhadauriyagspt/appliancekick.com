...
import { FaCheckCircle, FaShieldAlt, FaTools, FaArrowLeft, FaWrench, FaSearch, FaWater, FaTint } from 'react-icons/fa';
...
const WaterPurifierRepair = () => {
  ...
  const features = [
    {
      ...
      desc: "Replacing sediment and activated carbon filters to ensure clean and safe water output.",
      icon: <FaTint />
    },
    {
      title: "RO Membrane Fix",
      desc: "Restoring water quality by repairing or replacing high-performance RO membranes.",
      icon: <FaWater />
    },
    {
      title: "Pump Maintenance",
      desc: "Repairing or replacing high-pressure booster pumps for consistent water flow.",
      icon: <FaTools />
    },
    {
      title: "Electronic Board Fix",
      desc: "Repairing digital displays and control circuits for precise operation monitoring.",
      icon: <FaSearch />
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-white font-sans overflow-x-hidden">
      <Helmet>
        <title>Water Purifier Repair | Expert Filtration Service | Appliance Kick</title>
        <meta name="description" content="Professional repair and maintenance for all RO and UV water purifiers. Filter replacements, membrane cleaning, and certified technician support." />
      </Helmet>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
            ...
            <div className="w-full lg:w-1/2">
              <div className="relative group">
                ...
                <img
                  ...
                  alt="Water Purifier Repair Service"
                />
              </div>
            </div>
            ...
            <div className="w-full lg:w-1/2">
              <div className="inline-flex items-center gap-2.5 px-4 py-1.5 mb-6 rounded-full bg-gray-100 border border-gray-200">
                ...
                <span className="text-[#0f172a] text-xs font-bold uppercase tracking-wider">Health & Safety</span>
              </div>

              <h2 className="text-3xl md:text-5xl font-black text-[#0f172a] mb-8">
                Expert Solutions for <span className="text-[#1E63FF]">Filtration Systems</span>
              </h2>

              <p className="text-gray-500 text-lg md:text-xl leading-relaxed mb-10 font-medium">
                Clean drinking water is essential for your wellbeing. Our certified technicians specialize in diagnosing complex filtration issues, identifying membrane fouling, and ensuring all electrical sensors and pumps are working correctly to deliver safe water.
              </p>

              <div className="flex flex-col gap-5 mb-12">
                {[
                  "Detailed TDS monitoring and quality verification",
                  "Repairing water leaks and internal valve failures",
                  "Fixing inefficient pump and storage tank issues",
                  "Certified service for all leading global RO brands"
                ].map((item, index) => (
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-24 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-20">
            ...
            <h2 className="text-4xl md:text-5xl font-black text-[#0f172a] mb-6 leading-tight ">
              Filtration Repair <span className="text-[#ff6a00]">Specialists</span>
            </h2>
          </div>
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-24">
          <div className="bg-[#0B0F3B] rounded-[40px] p-10 md:p-16 lg:p-20 text-center relative overflow-hidden shadow-2xl">
            ...
            <h2 className="text-3xl md:text-5xl lg:text-6xl font-black text-white mb-10 leading-tight  relative z-10">
              Pure Water for Your Family <br />
              <span className="text-[#ff6a00]">Schedule Your Maintenance Today</span>
            </h2>

            <div className="flex justify-center relative z-10">
              <button
                onClick={() => openBookingModal('Water Purifier')}
