...
import { FaCheckCircle, FaShieldAlt, FaTools, FaArrowLeft, FaWrench, FaSearch, FaTshirt, FaFireAlt } from 'react-icons/fa';
...
const ClothesDryerRepair = () => {
  ...
  const features = [
    {
      title: "Heating Element Fix",
      desc: "Repairing or replacing faulty heating coils to restore efficient drying power.",
      icon: <FaFireAlt />
    },
    {
      title: "Vent Path Cleaning",
      desc: "Clearing lint blockages and internal exhaust paths to prevent fire hazards.",
      icon: <FaTools />
    },
    {
      title: "Drum Belt Service",
      desc: "Replacing snapped or worn-out drive belts to restore smooth drum rotation.",
      icon: <FaTshirt />
    },
    {
      title: "Thermal Fuse Repair",
      desc: "Diagnosing and replacing tripped thermal fuses for safe appliance operation.",
      icon: <FaSearch />
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-white font-sans overflow-x-hidden">
      <Helmet>
        <title>Clothes Dryer Repair | Professional Laundry Service | Appliance Kick</title>
        <meta name="description" content="Expert repair services for all residential clothes dryers. Certified maintenance for heating elements, belts, and vent cleaning." />
      </Helmet>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
            ...
            <div className="w-full lg:w-1/2">
              <div className="relative group">
                ...
                <img
                  ...
                  alt="Clothes Dryer Repair Service"
                />
              </div>
            </div>
            ...
            <div className="w-full lg:w-1/2">
              <div className="inline-flex items-center gap-2.5 px-4 py-1.5 mb-6 rounded-full bg-gray-100 border border-gray-200">
                ...
                <span className="text-[#0f172a] text-xs font-bold uppercase tracking-wider">Fast & Safe</span>
              </div>

              <h2 className="text-3xl md:text-5xl font-black text-[#0f172a] mb-8">
                Precision Repairs for <span className="text-[#1E63FF]">Laundry Equipment</span>
              </h2>

              <p className="text-gray-500 text-lg md:text-xl leading-relaxed mb-10 font-medium">
                Modern clothes dryers require precise heat management and airflow to operate safely. Our certified technicians specialize in identifying mechanical belt failures, electrical heating faults, and critical safety fuse issues across all major global brands.
              </p>

              <div className="flex flex-col gap-5 mb-12">
                {[
                  "Diagnostic audit of induction motors and rollers",
                  "Repairing gas igniters and electric heating coils",
                  "Fixing excessive noise and vibration problems",
                  "Certified service for all leading global dryer brands"
                ].map((item, index) => (
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-24 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-20">
            ...
            <h2 className="text-4xl md:text-5xl font-black text-[#0f172a] mb-6 leading-tight ">
              Laundry Repair <span className="text-[#ff6a00]">Specialists</span>
            </h2>
          </div>
