...
import { FaCheckCircle, FaShieldAlt, FaTools, FaArrowLeft, FaWrench, FaSearch, FaWater, FaSync } from 'react-icons/fa';
...
const DishwasherRepair = () => {
  ...
  const features = [
    {
      title: "Pump Restoration",
      desc: "Repairing or replacing circulation and drain pumps to ensure efficient cleaning cycles.",
      icon: <FaSync />
    },
    {
      title: "Leak Detection",
      desc: "Identifying and sealing water leaks within hoses, seals, and internal plumbing.",
      icon: <FaWater />
    },
    {
      title: "Heater Unit Fix",
      desc: "Replacing faulty heating elements to ensure proper water temperature and drying.",
      icon: <FaTools />
    },
    {
      title: "Spray Arm Service",
      desc: "Cleaning and repairing spray arms to restore optimal water distribution.",
      icon: <FaWrench />
    }
  ];
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
            ...
            <div className="w-full lg:w-1/2">
              <div className="inline-flex items-center gap-2.5 px-4 py-1.5 mb-6 rounded-full bg-gray-100 border border-gray-200">
                ...
                <span className="text-[#0f172a] text-xs font-bold uppercase tracking-wider">Quality Care</span>
              </div>

              <h2 className="text-3xl md:text-5xl font-black text-[#0f172a] mb-8">
                Precision Repairs for <span className="text-[#1E63FF]">Kitchen Tech</span>
              </h2>

              <p className="text-gray-500 text-lg md:text-xl leading-relaxed mb-10 font-medium">
                Modern dishwashers utilize complex water management systems and digital control boards. Our technicians are trained to identify specific cycle failures, sensor errors, and mechanical blockages to restore efficient cleaning.
              </p>

              <div className="flex flex-col gap-5 mb-12">
                {[
                  "Diagnostic audit of electronic control modules",
                  "Repairing water inlet valves and float switches",
                  "Fixing inefficient cleaning and drying issues",
                  "Certified service for built-in and portable units"
                ].map((item, index) => (
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-24 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-20">
            ...
            <h2 className="text-4xl md:text-5xl font-black text-[#0f172a] mb-6 leading-tight ">
              Kitchen Repair <span className="text-[#ff6a00]">Specialists</span>
            </h2>
          </div>
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-24">
          <div className="bg-[#0B0F3B] rounded-[40px] p-10 md:p-16 lg:p-20 text-center relative overflow-hidden shadow-2xl">
            ...
            <h2 className="text-3xl md:text-5xl lg:text-6xl font-black text-white mb-10 leading-tight  relative z-10">
              Stop Hand-Washing Dishes <br />
              <span className="text-[#ff6a00]">Restore Your Dishwasher Today</span>
            </h2>

            <div className="flex justify-center relative z-10">
              <button
                onClick={() => openBookingModal('Dishwasher')}
