...
import { FaCheckCircle, FaShieldAlt, FaTools, FaArrowLeft, FaWrench, FaSearch, FaMicrochip, FaBolt } from 'react-icons/fa';
...
const MicrowaveOvenRepair = () => {
  ...
  const features = [
    {
      title: "Magnetron Service",
      desc: "Diagnosing and replacing faulty magnetrons to restore heating power safely.",
      icon: <FaBolt />
    },
    {
      title: "High-Voltage Fix",
      desc: "Repairing high-voltage capacitors and transformers with strict safety protocols.",
      icon: <FaMicrochip />
    },
    {
      title: "Touch Panel Repair",
      desc: "Restoring responsiveness to control pads and digital display interfaces.",
      icon: <FaTools />
    },
    {
      title: "Door & Latch Service",
      desc: "Fixing faulty door interlock switches to ensure safe and efficient operation.",
      icon: <FaWrench />
    }
  ];
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
            ...
            <div className="w-full lg:w-1/2">
              <div className="inline-flex items-center gap-2.5 px-4 py-1.5 mb-6 rounded-full bg-gray-100 border border-gray-200">
                ...
                <span className="text-[#0f172a] text-xs font-bold uppercase tracking-wider">Safety First</span>
              </div>

              <h2 className="text-3xl md:text-5xl font-black text-[#0f172a] mb-8">
                Precision Fixes for <span className="text-[#1E63FF]">Heating Technology</span>
              </h2>

              <p className="text-gray-500 text-lg md:text-xl leading-relaxed mb-10 font-medium">
                Microwaves operate with high-voltage components that require professional handling. Our certified technicians use advanced diagnostic equipment to safely address issues like uneven heating, sparking, and electrical failures, ensuring your appliance meets all safety standards.
              </p>

              <div className="flex flex-col gap-5 mb-12">
                {[
                  "Safe diagnostic of high-voltage circuit systems",
                  "Repairing turntable motors and roller guides",
                  "Addressing sparking and internal electrical noise",
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-24 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-20">
            ...
            <h2 className="text-4xl md:text-5xl font-black text-[#0f172a] mb-6 leading-tight ">
              Microwave Repair <span className="text-[#ff6a00]">Specialists</span>
            </h2>
          </div>
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-24">
          <div className="bg-[#0B0F3B] rounded-[40px] p-10 md:p-16 lg:p-20 text-center relative overflow-hidden shadow-2xl">
            ...
            <div className="flex justify-center relative z-10">
              <button
                onClick={() => openBookingModal('Microwave Oven')}
