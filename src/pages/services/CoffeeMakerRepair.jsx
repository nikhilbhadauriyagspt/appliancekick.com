...
import { FaCheckCircle, FaShieldAlt, FaTools, FaArrowLeft, FaWrench, FaSearch, FaCoffee, FaTint } from 'react-icons/fa';
...
const CoffeeMakerRepair = () => {
  ...
  const features = [
    {
      title: "Brew Unit Service",
      desc: "Deep cleaning and mechanical restoration of the central brewing assembly.",
      icon: <FaCoffee />
    },
    {
      title: "Leak & Seal Fix",
      desc: "Identifying and replacing worn-out gaskets and internal water plumbing seals.",
      icon: <FaTint />
    },
    {
      title: "Pump Replacement",
      desc: "Restoring water pressure by repairing or replacing faulty high-pressure pumps.",
      icon: <FaTools />
    },
    {
      title: "Electronic Diagnostic",
      desc: "Repairing control panels and sensors for precise brewing temperature and timing.",
      icon: <FaSearch />
    }
  ];
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
            ...
            <div className="w-full lg:w-1/2">
              <div className="relative group">
                ...
                <img
                  ...
                  alt="Coffee Maker Repair Service"
                />
              </div>
            </div>
            ...
            <div className="w-full lg:w-1/2">
              <div className="inline-flex items-center gap-2.5 px-4 py-1.5 mb-6 rounded-full bg-gray-100 border border-gray-200">
                ...
                <span className="text-[#0f172a] text-xs font-bold uppercase tracking-wider">Specialized Care</span>
              </div>

              <h2 className="text-3xl md:text-5xl font-black text-[#0f172a] mb-8">
                Precision Fixes for <span className="text-[#1E63FF]">Brewing Technology</span>
              </h2>
              ...
              <div className="flex flex-col gap-5 mb-12">
                {[
                  "Systematic descaling and internal path cleaning",
                  "Repairing high-pressure pumps and heating units",
                  "Addressing boiler and steam wand malfunctions",
                  "Certified service for home and commercial models"
                ].map((item, index) => (
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-24 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-20">
            ...
            <h2 className="text-4xl md:text-5xl font-black text-[#0f172a] mb-6 leading-tight ">
              Professional Brew <span className="text-[#ff6a00]">Experts</span>
            </h2>
          </div>
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-24">
          <div className="bg-[#0B0F3B] rounded-[40px] p-10 md:p-16 lg:p-20 text-center relative overflow-hidden shadow-2xl">
            ...
            <h2 className="text-3xl md:text-5xl lg:text-6xl font-black text-white mb-10 leading-tight  relative z-10">
              Don't Miss Your Morning Brew <br />
              <span className="text-[#ff6a00]">Get Your Coffee Maker Fixed Today</span>
            </h2>

            <div className="flex justify-center relative z-10">
              <button
                onClick={() => openBookingModal('Coffee Maker')}
