...
import { FaCheckCircle, FaShieldAlt, FaTools, FaArrowLeft, FaWrench, FaSearch, FaSnowflake, FaWind } from 'react-icons/fa';
...
const AirConditionerRepair = () => {
  ...
  const features = [
    {
      title: "Gas Refilling",
      desc: "Safe and efficient refrigerant top-up to restore optimal cooling performance.",
      icon: <FaSnowflake />
    },
    {
      title: "Coil Cleaning",
      desc: "Deep cleaning of condenser and evaporator coils for maximum energy efficiency.",
      icon: <FaWind />
    },
    {
      title: "PCB Diagnostic",
      desc: "Expert repair of electronic control boards and circuit systems.",
      icon: <FaTools />
    },
    {
      title: "Filter Maintenance",
      desc: "Replacing or cleaning filters to ensure healthy and fresh indoor air quality.",
      icon: <FaWrench />
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-white font-sans overflow-x-hidden">
      <Helmet>
        <title>Air Conditioner Repair | Expert Cooling Solutions | Appliance Kick</title>
        <meta name="description" content="Professional AC repair and maintenance for all split and window units. Certified technicians and genuine spare parts for reliable cooling." />
      </Helmet>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
            ...
            <div className="w-full lg:w-1/2">
              <div className="inline-flex items-center gap-2.5 px-4 py-1.5 mb-6 rounded-full bg-gray-100 border border-gray-200">
                ...
                <span className="text-[#0f172a] text-xs font-bold uppercase tracking-wider">Premium Care</span>
              </div>

              <h2 className="text-3xl md:text-5xl font-black text-[#0f172a] mb-8">
                Comprehensive Fixes for <span className="text-[#1E63FF]">Cooling Systems</span>
              </h2>
              ...
              <div className="flex flex-col gap-5 mb-12">
                {[
                  ...
                  "Restoration of circuit boards and remote sensors",
                  "Optimizing compressor and motor efficiency",
                  "Eco-friendly servicing and part replacements"
                ].map((item, index) => (
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-24 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-20">
            <div className="inline-flex items-center gap-2.5 px-4 py-1.5 mb-6 rounded-full bg-white border border-gray-200">
              ...
              <span className="text-[#0f172a] text-xs font-bold uppercase tracking-wider">Our Services</span>
            </div>
            <h2 className="text-4xl md:text-5xl font-black text-[#0f172a] mb-6 leading-tight ">
              AC Maintenance <span className="text-[#ff6a00]">Experts</span>
            </h2>
          </div>
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-24">
          <div className="bg-[#0B0F3B] rounded-[40px] p-10 md:p-16 lg:p-20 text-center relative overflow-hidden shadow-2xl">
            ...
            <h2 className="text-3xl md:text-5xl lg:text-6xl font-black text-white mb-10 leading-tight  relative z-10">
              Don't Wait for the Heat <br />
              <span className="text-[#ff6a00]">Get Your AC Serviced Today</span>
            </h2>

            <div className="flex justify-center relative z-10">
              <button
                onClick={() => openBookingModal('Air Conditioner')}
