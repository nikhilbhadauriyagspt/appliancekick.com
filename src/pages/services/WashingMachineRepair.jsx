...
import { FaCheckCircle, FaShieldAlt, FaTools, FaClock, FaArrowLeft, FaWrench, FaSearch, FaCogs } from 'react-icons/fa';
  ...
  const features = [
    {
      ...
      desc: "Comprehensive diagnostic and repair of main control boards and display panels.",
      icon: <FaTools />
    },
    {
      title: "Drum & Bearing Fix",
      desc: "Replacing noisy bearings and fixing drum alignment for smooth operation.",
      icon: <FaCogs />
    },
    {
      title: "Drainage Solutions",
      desc: "Clearing blockages and repairing faulty pumps to ensure proper water drainage.",
      icon: <FaWrench />
    },
    {
      title: "Motor Diagnostics",
      desc: "Repairing or replacing high-performance motors to restore washing power.",
      icon: <FaSearch />
    }
  ];
      ...
      <section className="relative pt-44 pb-32 bg-[#0B0F3B] overflow-hidden">
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-24 relative z-10 text-center">
          ...
          <h1 className="text-4xl md:text-7xl font-black text-white mb-8 leading-tight ">
            Washing Machine <span className="text-[#ff6a00]">Repair</span>
          </h1>
          <p className="text-white/60 text-lg md:text-xl font-medium max-w-3xl mx-auto leading-relaxed">
            Professional diagnostic and restoration services for all front-load, top-load, and semi-automatic washing machine systems.
          </p>
        </div>
      </section>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
            ...
            <div className="w-full lg:w-1/2">
              <div className="inline-flex items-center gap-2.5 px-4 py-1.5 mb-6 rounded-full bg-gray-100 border border-gray-200">
                ...
                <span className="text-[#0f172a] text-xs font-bold uppercase tracking-wider">Expert Maintenance</span>
              </div>

              <h2 className="text-3xl md:text-5xl font-black text-[#0f172a] mb-8 leading-tight uppercase tracking-tight">
                Systematic Fixes for <span className="text-[#1E63FF]">Laundry Equipment</span>
              </h2>
              ...
              <div className="flex flex-col gap-5 mb-12">
                {[
                  "Complete motor and drive system diagnostics",
                  "Repairing drainage pumps and water inlet valves",
                  "Fixing noise, vibration, and balance issues",
                  "Certified work on all leading global brands"
                ].map((item, index) => (
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-24 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-20">
            <div className="inline-flex items-center gap-2.5 px-4 py-1.5 mb-6 rounded-full bg-white border border-gray-200">
              ...
              <span className="text-[#0f172a] text-xs font-bold uppercase tracking-wider">Our Capabilities</span>
            </div>
            <h2 className="text-4xl md:text-5xl font-black text-[#0f172a] mb-6 leading-tight ">
              Common Problems <span className="text-[#ff6a00]">We Fix</span>
            </h2>
          </div>
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-24">
          <div className="bg-[#0B0F3B] rounded-[40px] p-10 md:p-16 lg:p-20 text-center relative overflow-hidden shadow-2xl">
            ...
            <h2 className="text-3xl md:text-5xl lg:text-6xl font-black text-white mb-10 leading-tight  relative z-10">
              Quick & Reliable <br />
              <span className="text-[#ff6a00]">Service is Just a Click Away</span>
            </h2>
