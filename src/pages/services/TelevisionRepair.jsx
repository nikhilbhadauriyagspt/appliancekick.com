...
import { FaCheckCircle, FaShieldAlt, FaTools, FaArrowLeft, FaWrench, FaSearch, FaTv, FaMicrochip } from 'react-icons/fa';
  ...
  const features = [
    {
      ...
      desc: "Diagnosing and repairing screen issues including backlighting, lines, and color distortions.",
      icon: <FaTv />
    },
    {
      title: "Main Board Fix",
      desc: "Repairing or replacing critical logic boards and signal processing components.",
      icon: <FaMicrochip />
    },
    {
      title: "Power Supply Service",
      desc: "Addressing power-related failures, including circuit restoration and fuse replacements.",
      icon: <FaTools />
    },
    {
      title: "Audio Diagnostic",
      desc: "Fixing sound distortions and speaker failures for a complete entertainment experience.",
      icon: <FaSearch />
    }
  ];
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
            ...
            <div className="w-full lg:w-1/2">
              <div className="inline-flex items-center gap-2.5 px-4 py-1.5 mb-6 rounded-full bg-gray-100 border border-gray-200">
                ...
                <span className="text-[#0f172a] text-xs font-bold uppercase tracking-wider">Premium Service</span>
              </div>

              <h2 className="text-3xl md:text-5xl font-black text-[#0f172a] mb-8">
                Expert Tech for <span className="text-[#1E63FF]">Home Entertainment</span>
              </h2>

              <p className="text-gray-500 text-lg md:text-xl leading-relaxed mb-10 font-medium">
                Modern televisions are highly sophisticated electronic devices. Our certified technicians utilize advanced diagnostic tools to pinpoint circuit failures, backlight issues, and software glitches across all major global brands.
              </p>

              <div className="flex flex-col gap-5 mb-12">
                {[
                  "Component-level repair of main and T-Con boards",
                  "Restoration of LED backlighting and connectivity ports",
                  "Firmware updates and software troubleshooting",
                  "Certified service for all leading Smart TV manufacturers"
                ].map((item, index) => (
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-24 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-20">
            ...
            <h2 className="text-4xl md:text-5xl font-black text-[#0f172a] mb-6 leading-tight ">
              Electronics Repair <span className="text-[#ff6a00]">Experts</span>
            </h2>
          </div>
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-24">
          <div className="bg-[#0B0F3B] rounded-[40px] p-10 md:p-16 lg:p-20 text-center relative overflow-hidden shadow-2xl">
            ...
            <h2 className="text-3xl md:text-5xl lg:text-6xl font-black text-white mb-10 leading-tight  relative z-10">
              Don't Miss Your Favorite Show <br />
              <span className="text-[#ff6a00]">Get Your TV Fixed Today</span>
            </h2>

            <div className="flex justify-center relative z-10">
              <button
                onClick={() => openBookingModal('Television')}
