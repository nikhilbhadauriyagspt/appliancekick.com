...
import { FaCheckCircle, FaShieldAlt, FaTools, FaArrowLeft, FaWrench, FaSearch, FaSnowflake, FaThermometerHalf } from 'react-icons/fa';
...
const RefrigeratorRepair = () => {
  ...
  const features = [
    {
      ...
      desc: "Comprehensive diagnostic to fix inadequate cooling and temperature fluctuations.",
      icon: <FaSnowflake />
    },
    {
      title: "Thermostat Repair",
      desc: "Calibrating and replacing faulty thermostats for accurate temperature control.",
      icon: <FaThermometerHalf />
    },
    {
      title: "Gas Leak Fix",
      desc: "Identifying and sealing refrigerant leaks followed by a professional recharge.",
      icon: <FaTools />
    },
    {
      title: "Compressor Service",
      desc: "Repairing or replacing critical compressor units to restore system integrity.",
      icon: <FaWrench />
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-white font-sans overflow-x-hidden">
      <Helmet>
        <title>Refrigerator Repair | Expert Cooling Solutions | Appliance Kick</title>
        <meta name="description" content="Professional refrigerator repair for all major brands. Same-day service for cooling issues, compressor faults, and genuine part replacements." />
      </Helmet>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
            ...
            <div className="w-full lg:w-1/2">
              <div className="inline-flex items-center gap-2.5 px-4 py-1.5 mb-6 rounded-full bg-gray-100 border border-gray-200">
                ...
                <span className="text-[#0f172a] text-xs font-bold uppercase tracking-wider">Reliable Fixes</span>
              </div>

              <h2 className="text-3xl md:text-5xl font-black text-[#0f172a] mb-8">
                Expert Diagnostics for <span className="text-[#1E63FF]">Cooling Appliances</span>
              </h2>

              <p className="text-gray-500 text-lg md:text-xl leading-relaxed mb-10 font-medium">
                A malfunctioning refrigerator can lead to food spoilage and unnecessary stress. Our certified technicians specialize in identifying issues within complex cooling circuits, electronic control modules, and mechanical seals to restore your unit to its original performance.
              </p>

              <div className="flex flex-col gap-5 mb-12">
                {[
                  "Precise temperature calibration and thermostat testing",
                  "Repairing advanced ice maker and water dispenser units",
                  "Fixing seal leaks and door alignment issues",
                  "Certified service for all leading refrigerator brands"
                ].map((item, index) => (
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-24 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-20">
            ...
            <h2 className="text-4xl md:text-5xl font-black text-[#0f172a] mb-6 leading-tight ">
              Cooling Repair <span className="text-[#ff6a00]">Specialists</span>
            </h2>
          </div>
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-24">
          <div className="bg-[#0B0F3B] rounded-[40px] p-10 md:p-16 lg:p-20 text-center relative overflow-hidden shadow-2xl">
            ...
            <h2 className="text-3xl md:text-5xl lg:text-6xl font-black text-white mb-10 leading-tight  relative z-10">
              Save Your Food & Energy <br />
              <span className="text-[#ff6a00]">Book an Expert Fix Now</span>
            </h2>
